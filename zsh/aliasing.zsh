...
alias brew-up='brew-fix; brew update; brew-fix'
alias brew-upgrade-all='brew-fix; brew upgrade --all; brew-fix'
alias brew-fix='sudo chown $(whoami):admin /usr/local && sudo chown -R $(whoami):admin /usr/local'
